...
public final class projectDetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<span style=\"font-weight:bold;\">Código:</span>");
      if (_jspx_meth_s_property_1(_jspx_page_context))
        return;
      out.write("<br/><br/>\r\n");
      out.write("\t<span style=\"font-weight:bold;\">Descrição:</span>");
      if (_jspx_meth_s_property_2(_jspx_page_context))
        return;
      out.write("<br/><br/>\r\n");
      out.write("\t<span style=\"font-weight:bold;\">Local:</span>");
      if (_jspx_meth_s_property_3(_jspx_page_context))
        return;
      out.write("<br/><br/>\t\r\n");
      out.write("\t<span style=\"font-weight:bold;\">Deadline:</span>");
  ...
  private boolean _jspx_meth_s_property_0(PageContext _jspx_page_context)
    ...
    _jspx_th_s_property_0.setValue("project.name");
  ...
  private boolean _jspx_meth_s_property_1(PageContext _jspx_page_context)
    ...
    _jspx_th_s_property_1.setValue("project.id");
  ...
  private boolean _jspx_meth_s_property_2(PageContext _jspx_page_context)
    ...
    _jspx_th_s_property_2.setValue("project.description");
  ...
  private boolean _jspx_meth_s_property_3(PageContext _jspx_page_context)
    ...
    _jspx_th_s_property_3.setValue("project.location");
  ...
  private boolean _jspx_meth_s_date_0(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  s:date
    org.apache.struts2.views.jsp.DateTag _jspx_th_s_date_0 = (org.apache.struts2.views.jsp.DateTag) _jspx_tagPool_s_date_nice_name_nobody.get(org.apache.struts2.views.jsp.DateTag.class);
    _jspx_th_s_date_0.setPageContext(_jspx_page_context);
    _jspx_th_s_date_0.setParent(null);
    _jspx_th_s_date_0.setName("project.lastDate");
    _jspx_th_s_date_0.setNice(true);
    int _jspx_eval_s_date_0 = _jspx_th_s_date_0.doStartTag();
    if (_jspx_th_s_date_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_s_date_nice_name_nobody.reuse(_jspx_th_s_date_0);
      return true;
    }
    _jspx_tagPool_s_date_nice_name_nobody.reuse(_jspx_th_s_date_0);
    return false;
  ...
  private boolean _jspx_meth_s_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_s_if_0.setTest("%{isUser('MANAGER') || isUser('ADMIN')}");
    ...
    if (_jspx_eval_s_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("/admin/project/addIteration.jsp?project=");
        ...
        out.write("\"><button>Adicionar Iteração</button></a>\r\n");
        out.write("\t");
  ...
  private boolean _jspx_meth_s_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_s_if_1.setTest("%{isUser('MANAGER') || isUser('RESOURCE') || isUser('CLIENT')}");
    ...
    if (_jspx_eval_s_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t<a href=\"#\"><button>Adicionar Comentário</button></a>\r\n");
        out.write("\t");
  ...
  private boolean _jspx_meth_s_include_0(PageContext _jspx_page_context)
    ...
    _jspx_th_s_include_0.setValue("listIterations.jsp");
